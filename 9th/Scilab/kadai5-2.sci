...
// <課題5.1>-2 データの表示を兼ねる
X = csvRead("data/kadai5-1.csv");	// データを読み込む. ファイル名は適宜変更せよ.
...
N=size(X,1);
// <課題5.1>-2用
xmin = 6.0;	// 1周期の始まりよりちょっと前
xmax = 15.0;	// 1周期の終わりよりちょっと後
ymin = 2000;
ymax = 5000;
yhigh = 4300;	// 10.5～11.5[s] のYから
ylow  = 2500;	// 14.5～15.75[s] のYから
T0 = 7.7;	// Uのグラフから
T1 = 8.25;	// y1=ylow+(1-e^{-1})(yhigh-ylow)とYの交点から
// ここまで
// <課題5.1>-3 ---ここから---
// つぎのコメントを外して, 読み取った値を代入せよ.
/*-------------
xmin = 5.0;	// 1周期の始まりよりちょっと前
